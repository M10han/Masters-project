...
parser.add_argument('--pretrain', dest='pretrain', type=bool, default=True, help='Pretrain the DBN')
parser.add_argument('--finetune', dest='finetune', type=bool, default=True, help='Finetune the model')
...
def test_DBN(finetune_lr=0.1, pretraining_epochs=10,
             ...
             dataset='tzanetakis', batch_size=100):
    """
    ...
    if args.pretrain:
        ...
        print('Save the model before fine-tuning:')
